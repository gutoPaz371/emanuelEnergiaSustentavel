    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="row flex-center min-vh-100 py-6 text-center">
          <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5"><a class="d-flex flex-center mb-4" href="../../index.html"><img class="me-2" src="../../assets/img/icons/spot-illustrations/falcon.png" alt="" width="58" /><span class="font-sans-serif fw-bolder fs-5 d-inline-block">Emanuel </span></a>
            <div class="card">
              <div class="card-body p-4 p-sm-5">
                <div class="fw-black lh-1 text-300 fs-error">404</div>
                <p class="lead mt-4 text-800 font-sans-serif fw-semi-bold w-md-75 w-xl-100 mx-auto">A página que você está procurando não foi encontrada.</p>
                <hr />
                <p>Verifique se o endereço está correto e se a página não foi movida.<a href="mailto:info@exmaple.com"></a></p><a class="btn btn-primary btn-sm mt-3" href="../../<?php $_GET['pg']; ?>"><span class="fas fa-home me-2"></span>Voltar a Home</a>
              </div>
            </div>
          </div>
        </div>
