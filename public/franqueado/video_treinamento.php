    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="content">
          ...
          </div><a href="./list_treinamento.php" class="btn btn-falcon-info me-1 mb-1" type="button"><i class="fas fa-arrow-left"></i></a>
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-045cc5a3-2b8f-4262-8ad9-27e37717e846" id="dom-045cc5a3-2b8f-4262-8ad9-27e37717e846">
                  <div class="ratio ratio-16x9">

                    <iframe src="https://www.youtube.com/embed/<?php echo $_GET['link']; ?>" allowfullscreen="allowfullscreen" title="YouTube video"></iframe>

                  </div>
                </div>
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-0826ebb5-2cb4-41b4-a03a-63a51b364966" id="dom-0826ebb5-2cb4-41b4-a03a-63a51b364966">
