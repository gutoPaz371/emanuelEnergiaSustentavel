            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link" href="loja.php" role="button" data-bs-toggle="" aria-expanded="false">
                  ...
                  <ul class="nav collapse" id="email" style="">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="./processos/verif_franqueado_pro.php" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
  ...
  <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
            <div class="bg-white dark__bg-1000 rounded-2 py-2">
              <a class="dropdown-item" href="./config_franqueado.php?pg=list_leads_franqueado_pro.php">Configurações</a>
          ...
          <!--TABLE USER START-->
                    ...
                    <h1 class="display-4 mb-3" style="text-align:center;">TODOS OS LEADS PRO</h1>
                              ...
                              <?php while ($dado = $res->fetch_array()){?>
                                <tr class="align-middle hover-actions-trigger">
                                    ...
                                    <td class="text-nowrap">
                                        <div class="d-flex align-items-center">
                                            <div class="ms-2">Joaqui Neto</div>
                                        </div>
                                    </td>
                                    <td class="text-nowrap">neto@gmail.com</td>
                                    ...
                                    <td class="w-auto">
                                        <div class="btn-group btn-group hover-actions end-0 me-4">
                                            <a href="./edit_leads_franqueado.php?nome=Tiago Azevedo&email=tiagotf@gmail.com&numero=(91) 99 9 9999-9999&endereco=2392 Main Avenue, Penasauka&st=1&venda=R$99,00&pg=list_leads_franqueado_pro.php" class="btn btn-light pe-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="fas fa-edit"></span></a>
                                          ...
                                          <div>
                                            <span class="badge badge rounded-pill d-block p-2 badge-soft-info">Em processo<span class="ms-1 fas fa-info" data-fa-transform="shrink-2"></span></span>
                                          </div> 
