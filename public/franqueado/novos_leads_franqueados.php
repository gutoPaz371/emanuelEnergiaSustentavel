...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Emanuel | Novos Leads</title>
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="email" style="">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="./novos_leads_franqueados.php" data-bs-toggle="" aria-expanded="false">
        ...
        <div class="content">
              ...
              <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                        <div class="bg-white dark__bg-1000 rounded-2 py-2">
                          <a class="dropdown-item" href="./config_franqueado.php?pg=novos_leads_franqueados.php">Configurações</a>
          ...
          <div id="form2" class="col-lg-6 col-xl-12 col-xxl-6 h-100">
              ...
              <div class="card theme-wizard h-100 mb-5">
                <div class="card-header bg-light pt-3 pb-2">
                  <ul class="nav justify-content-between nav-wizard">
                    <li class="nav-item"><a class="nav-link active fw-semi-bold" href="#bootstrap-wizard-validation-tab1" data-bs-toggle="tab" data-wizard-step="data-wizard-step"><span class="nav-item-circle-parent"><span class="nav-item-circle"><svg class="svg-inline--fa fa-lock fa-w-14" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="lock" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M400 224h-24v-72C376 68.2 307.8 0 224 0S72 68.2 72 152v72H48c-26.5 0-48 21.5-48 48v192c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V272c0-26.5-21.5-48-48-48zm-104 0H152v-72c0-39.7 32.3-72 72-72s72 32.3 72 72v72z"></path></svg><!-- <span class="fas fa-lock"></span> Font Awesome fontawesome.com --></span></span><span class="d-none d-md-block mt-1 fs--1">Dados</span></a></li>
                ...
                <div class="card-body py-4" id="wizard-controller">
                  <div class="tab-content">
                    <div class="tab-pane active px-sm-3 px-md-5" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab1" id="bootstrap-wizard-validation-tab1">
                      <form  class="needs-validation" novalidate="novalidate" action="./processos/add_leads_franqueado.php" method="post">
                        <div class="mb-3">
                          <label class="form-label" for="bootstrap-wizard-validation-wizard-name">Nome*</label>
                          <input required="required" class="form-control" type="text" name="name" placeholder="Nome" id="bootstrap-wizard-validation-wizard-name">
                          <div class="invalid-feedback">Você precisa adicionar um nome</div>                            
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="row g-2">
                          <div class="col-6">
                            <div class="mb-3">
                              ...
                              <input onkeypress="number(this)" class="form-control" type="" name="telefone" maxlength="16" placeholder="(99) 9 9999-9999" required="required" id="Number" data-wizard-validate-password="true">
                              <div class="invalid-feedback">Adicione um numero para contato.</div>
                            </div>
                          ...
                          <div class="col-6" hidden>
                            <div class="mb-3">
                              ...
                              <input class="form-control" value="000000" type="password" placeholder="Confirmar Senha" required="required" data-wizard-validate-confirm-password="true">
                    ...
                    <div class="tab-pane px-sm-3 px-md-5" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab2" id="bootstrap-wizard-validation-tab2">
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" type="text" name="estado" placeholder="Estado" id="">
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="bootstrap-wizard-validation-wizard-phone">Cidade</label>
                          <input class="form-control" type="text" name="cidade" placeholder="Cidade" id="">
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="bootstrap-wizard-validation-wizard-phone">Bairro</label>
                          <input class="form-control" type="text" name="bairro" placeholder="Bairro" id="">
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="bootstrap-wizard-validation-wizard-phone">Rua</label>
                          <input class="form-control" type="text" name="rua" placeholder="Rua" id="">
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="bootstrap-wizard-validation-wizard-phone">Cep</label>
                          <input class="form-control" type="text" name="cep" placeholder="Cep" id="">
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="bootstrap-wizard-validation-wizard-phone">Numero</label>
                          <input class="form-control" type="" name="num" placeholder="Numero" id="">
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="bootstrap-wizard-validation-wizard-phone">Complemento</label>
                          <input class="form-control" type="" name="complemento" placeholder="Complemento" id="">
                        </div>
                    ...
                    <div class="tab-pane text-center px-sm-3 px-md-5" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab4" id="bootstrap-wizard-validation-tab4">
                      ...
                      <p>Iremos cadastrar o novo seu novo lead no banco</p><button class="btn btn-primary px-5 my-3" type="submit">Cadastrar</button>
                    </form>
                    </div>
                  </div>
                </div>
