        ...
        <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            ...
            <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                  <a class="dropdown-item" href="./config_franqueado.php?pg=edit_leads_franqueado.php&pg2=<?php echo $_GET['pg']; ?>">Configurações</a>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body position-relative">
              <div class="row">
                <div class="col-lg-8">
                  <h3 style="text-align:center;">EDITAR LEADS</h3>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-4a863c17-bf7f-4829-9da2-65f6eca5676e" id="dom-4a863c17-bf7f-4829-9da2-65f6eca5676e">
                      <div class="table-responsive scrollbar">
                        <form action="../../crud/users/edit_leads_franqueado.php" method="POST">
                          <input type="" name="pg" value="<?php if(isset($_GET['pg']))echo $_GET['pg'];else echo $_GET['pg2'] ?>" hidden/>
                          <input name="id_leads" value="<?php echo $_GET['id_leads']; ?>" hidden/>
                          <div style="text-align:center ;"><br>
                            <label for="">TIPO DE USUARIO</label><br>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" id="" type="radio" name="tipo_cliente" value="0" <?php if(!$_GET['st'])echo 'checked' ?>/>
                              <label class="form-check-label" for="inlineRadio1">Leads</label>
                            </div>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" id="" type="radio" name="tipo_cliente" value="1" <?php if($_GET['st'])echo 'checked' ?>/>
                          ...
                          <table class="table">
                            ...
                            <tbody><br>
                              <tr>
                                <td>NOME: </td>
                                <td><input name="nome" value="<?php echo $_GET['nome'] ?>" class="form-control" /></td>
                              </tr>
                              <tr>
                                <td>EMAIL: </td>
                                <td><input name="email" value="<?php echo $_GET['email'] ?>" class="form-control" /></td>
                              </tr>
                              <tr>
                                <td>NUMERO: </td>
                                <td><input name="numero" value="<?php echo $_GET['numero'] ?>" class="form-control" /></td>
                              </tr>
                            </tbody>
                          </table>
                        <button class="btn btn-falcon-success me-1 mb-1" type="submit">Atualizar</button>
                        <a class="btn btn-falcon-default me-1 mb-1" href="./<?php if(isset($_GET['pg']))echo $_GET['pg'];else echo $_GET['pg2']; ?>" type="button">Voltar</a>
                      </form>
                      </div>
                    </div>
                  </div>
