<?php
    ...
    if(isset($_SESSION['st_docs'])){
      $st_docs=$_SESSION['st_docs'];
    }else{
      $st_docs=0;
    }
  ...
  <div class="container-fluid" data-layout="container">
    ...
    <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
        ...
        <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
            ...
            <a class="dropdown-item" href="./edit_user_gerente.php?pg=docs_franqueado.php">Configurações</a>
    ...
    <?php 
                    ...
                    <tr class="align-middle">
                      ...
                      <td>
                        ...
                        <script>
                          ...
                          }verifi_user_stDocs(<?php echo $st_docs; ?>);
                        </script>
                      </td>
                      <td class="text-end">
                      <div class="form-check form-switch">
                        <form action="../documentacao/processos/att_status_docs.php" method="POST">
                          <input name="status_docs" id="st" class="form-check-input" id="flexSwitchCheckChecked" type="checkbox" <?php if($st_docs) echo "checked=''"; ?> />
                            
                      </div>
                      
                      </td>
                      <td class="text-end">
                        <a href="#" target="iframe_download" class="btn btn-falcon-primary me-1 mb-1" type="button"><svg class="svg-inline--fa fa-download fa-w-16" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="download" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M216 0h80c13.3 0 24 10.7 24 24v168h87.7c17.8 0 26.7 21.5 14.1 34.1L269.7 378.3c-7.5 7.5-19.8 7.5-27.3 0L90.1 226.1c-12.6-12.6-3.7-34.1 14.1-34.1H192V24c0-13.3 10.7-24 24-24zm296 376v112c0 13.3-10.7 24-24 24H24c-13.3 0-24-10.7-24-24V376c0-13.3 10.7-24 24-24h146.7l49 49c20.1 20.1 52.5 20.1 72.6 0l49-49H488c13.3 0 24 10.7 24 24zm-124 88c0-11-9-20-20-20s-20 9-20 20 9 20 20 20 20-9 20-20zm64 0c0-11-9-20-20-20s-20 9-20 20 9 20 20 20 20-9 20-20z"></path></svg><!-- <i class="fas fa-download"></i> Font Awesome fontawesome.com --></a>
                      </td>
                    </tr>
                  </tbody>
                </table>
      ...
      <a href="./list_user.php" class="btn btn-falcon-info me-1 mb-1" type="button">Voltar</a>
        <input name="id_franqueado" value="2" hidden/>
        <button class="btn btn-falcon-success me-1 mb-1" type="submit">Salvar</button>
      </form>
      <footer class="footer">
...
<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas" aria-hidden="true" style="visibility: hidden;">
  ...
  </div></div></div><div class="os-scrollbar os-scrollbar-horizontal os-scrollbar-unusable os-scrollbar-auto-hidden"><div class="os-scrollbar-track os-scrollbar-track-off"><div class="os-scrollbar-handle" style="width: 100%; transform: translate(0px, 0px);"></div></div></div><div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden"><div class="os-scrollbar-track os-scrollbar-track-off"><div class="os-scrollbar-handle" style="height: 50.6647%; transform: translate(0px, 336px);"></div></div></div><div class="os-scrollbar-corner"></div></div>
