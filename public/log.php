  ...
  <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
            <div class="bg-white dark__bg-1000 rounded-2 py-2">
              <a class="dropdown-item" href="./edit_user_gerente.php?pg=log.php">Configurações</a>
            ...
            <!--TABLE SELL START--><h1 class="display-4 mb-3" style="text-align:center;">LOG</h1>
            <div class="card">
            ...
            <div class="card-body fs--1 p-0">
              <a class="border-bottom-0 notification rounded-0 border-x-0 border border-300" href="#!">
                ...
                <div class="notification-body">
                  <p class="mb-1"><strong>{Usuario}</strong> {ação} <strong>{Alvo da ação}</strong></p>
                  <span class="notification-time">{Hh:Mm:Ss - Dd/Mm/Aa}</span>
