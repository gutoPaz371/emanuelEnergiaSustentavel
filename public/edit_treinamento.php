            ...
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body pt-0">
                  <div class="tab-content"><h3 style="text-align:center ;">Editar Video</h3>
                    <div class="tab-pane preview-tab-pane active d-flex" aria-labelledby="tab-dom-4a863c17-bf7f-4829-9da2-65f6eca5676e" id="dom-4a863c17-bf7f-4829-9da2-65f6eca5676e">
                      ...
                      <div class="table-responsive">
                        <form action="../crud/treinamento/edit_treinamento.php" method="POST">
                          <input name="id_video" value="<?php echo $_GET['id']; ?>" hidden/>
                          <label id="order_" class="form-label" for="customRange1">ORDEM: </label>
                          <input name="order_treinamento" id="order_number" oninput="cont_order(this)" value="<?php echo $res['ordem']; ?>" class="form-range" id="" type="range" min="0" max="25" step="1"/>
                          <label for="">NOME</label>
                          <input value="<?php echo $res['nome']; ?>" name="nome_treinamento" class="form-control"/>
                          <label for="">URL</label>
                          <input value="https://www.youtube.com/embed/<?php echo $res['url']; ?>" onblur="show_video(this)" id="URl" name="URL" class="form-control"/><br><br>
                      ...
                      <div class="table-responsive ms-auto">
                        <iframe id="video" width="350" height="245" src="https://www.youtube.com/embed/<?php echo $res['url'];?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                      </div>
                    </div>
                  </div>
                </div>
