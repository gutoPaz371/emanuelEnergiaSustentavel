            ...
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link" href="./list_produtos.php" role="button" data-bs-toggle="" aria-expanded="false">
                  ...
                  <!-- parent pages--><a class="nav-link active" href="./list_user_pro.php" role="button" data-bs-toggle="" aria-expanded="false">
  ...
  <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
            <div class="bg-white dark__bg-1000 rounded-2 py-2">
              <a class="dropdown-item" href="./edit_user_gerente.php?pg=list_user_pro.php">Configurações</a>
          ...
          <!--TABLE USER START-->
                    <div id="form1" class="table-responsive scrollbar">
                      <h1 class="display-4 mb-3" style="text-align:center;">FRANQUEADOS PRO</h1>
                        <div class="card-header border-bottom">
                            <div class="row flex-between-end">   
                                ...
                                </div><button hidden onclick="x1(this)" style="width: 10%;" class="btn btn-outline-success me-1 mb-1" type="button">
                            ...
                            <tbody>
                                <tr class="align-middle hover-actions-trigger">
                                    ...
                                    <td class="text-nowrap">
                                        <div class="d-flex align-items-center">
                                            <div class="ms-2">Tiago Azevedo</div>
                                        </div>
                                    </td>
                                    <td class="text-nowrap">tiagotf@gmail.com</td>
                                    <td class="text-nowrap">(91) 99 9 9999-9999</td>
                                    <td class="text-nowrap">2392 Main Avenue, Penasauka</td>
                                    <td class="w-auto">
                                        <div class="btn-group btn-group hover-actions end-0 me-4">
                                            <a href="./edit_users.php?nome=Tiago Azevedo&email=tiagotf@gmail.com&numero=(91) 99 9 9999-9999&endereco=2392 Main Avenue, Penasauka&st=1&venda=R$99,00&pg=list_user_pro.php" class="btn btn-light pe-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="fas fa-edit"></span></a>
                                            
                                              <input value="15" name="id_user_franqueado" hidden/>
                                              <button class="btn btn-light ps-2" type="button" data-bs-toggle="modal" data-bs-target="#scrollinglongcontent" data-bs-placement="top" title="Delete"><span class="fas fa-trash-alt"></span></button>
                                          ...
                                          <?php $st_user=0; ?>
                                          <div id="active" <?php if(!$st_user)echo 'hidden';?>>
                                          ...
                                          <div id="desactive" <?php if($st_user)echo 'hidden';?>>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button class="btn btn-danger me-1 mb-1" type="submit ">Sim</button>
                </div>
              </form>
              </div>
            </div>
